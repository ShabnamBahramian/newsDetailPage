  ...
  return (
    <React.Fragment>
      <div
        ...
        className="flex-row w-20 h-10 pt-2 text-center bg-gray-50 text-sm border border-gray-200"
      >
        {" "}
        اخبار
      </div>
      ...
      <div
        ...
        className="flex-row w-28 h-10 pt-2 text-center bg-gray-50 text-sm border border-gray-200"
      >
        {" "}
        آرشیو نظرات
      </div>
